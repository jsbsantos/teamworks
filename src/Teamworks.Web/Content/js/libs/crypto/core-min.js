...
var CryptoJS = CryptoJS || function(h, o) {
    var f = { }, j = f.lib = { }, k = j.Base = function() {
        ...
        return {
            ...
            clone: function() { return this.$super.extend(this); }
        };
        ...
        toString: function(a) { return (a || p).stringify(this); },
        concat: function(a) {
        ...
        parse: function(a) { return n.parse(unescape(encodeURIComponent(a))); }
        ...
        _process: function(a) {
            var b = this._data, c = b.words, d = b.sigBytes, e = this.blockSize, f = d / (4 * e), f = a ? h.ceil(f) : h.max((f | 0) - this._minBufferSize, 0), a = f * e, d = h.min(4 * a, d);
            if (a) {
    ...
    j.Hasher = m.extend({
        ...
        blockSize: 16,
        _createHelper: function(a) { return function(b, c) { return a.create(c).finalize(b); }; },
        _createHmacHelper: function(a) { return function(b, c) { return r.HMAC.create(a, c).finalize(b); }; }
    });
    var r = f.algo = { };
    return f;
}(Math);