    (function (pages) {
        pages.RegisterTimelogsViewModel = function (data, json) {
                ...
                create: function (options) {
                    return (new (function () {
                        ...
                        this._update = function () {
                            var timelog = this;
                            self.timelogs.input.updating(true);
                            $.ajax({
                                type: 'post',
            ...
            self.timelogs.input.clear = function () {
                self.timelogs.input.date(now);
                self.timelogs.input.description("");
                self.timelogs.input.duration(0);
                self.timelogs.input.updating(false);
            ...
            ****************************************/
            ...
            self.timelogs.total = ko.computed(function () {
                ...
                return juration.stringify(total);
            });
