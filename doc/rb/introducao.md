...
A gestão de um projecto não se resume à organização de tempo, é também necessário para uma boa gestão planeamento, organização, controlo de recursos e monitorização. 
...
Para além da gestão do projecto é também importante gerir as pessoas que dele fazem parte. A comunicação entre pessoas de um projecto pode ter um grande impacto na qualidade e velocidade com que o produto final é entregue. 
Devido a isto a plataforma desenvolvida para além de projectos também gere equipas.
...
Um exemplo deste tipo de aplicações é a aplicação *Microsoft Project* \cite{mproject} usada para o planeamento de tarefas, estimar a sua duração e atribuir-lhe recursos. 
...
A aplicação web acenta sobre a Api e tem uma interface simples com o objectivo de minimizar o tempo utilizado na plataforma.

As funcionalidades diponibilizadas permitem a gestão de projectos e pessoas. 
