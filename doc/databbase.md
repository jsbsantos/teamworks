...
Internamente, o RavenDB usa índices [_Lucene_](http://lucene.apache.org/) que são criados automaticamente com a utilização do sistema ou criados explicitamente pelo programador através de expressões [Map-Reduce](http://www.mapreduce.org/what-is-mapreduce.php). 